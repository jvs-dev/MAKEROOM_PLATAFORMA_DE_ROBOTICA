        ...
        try {
          ...
          try {
            ...
            if (userDoc.exists()) {
              ...
              if (auth.currentUser.email === 'jvssilv4@gmail.com' && (!userDataObj.admin || userDataObj.role !== 'admin')) {
                userDataObj.admin = true;
                userDataObj.role = 'admin';
              ...
              await setDoc(doc(db, 'users', auth.currentUser.email), userDataObj);
              setUserData(userDataObj);
            }
          } catch (err) {
          ...
          if (auth.currentUser && userDataObj) {
            ...
            try {
              ...
              const filteredLessons = lessonsList.filter(lesson => 
                !lesson.teamId || lesson.teamId === (userDataObj?.teamId || null)
              );
          ...
          // Inner errors are already handled, but this catches unexpected ones
          console.error('Home fetchData unexpected error:', err);
        }
      }
      setIsLoading(false);
    };
