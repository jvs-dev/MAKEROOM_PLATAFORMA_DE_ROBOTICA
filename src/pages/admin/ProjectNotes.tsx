    ...
    <div className="space-y-8">
      <header className="flex flex-col md:flex-row items-center justify-between gap-6">
        <div>
          <h1 className="text-3xl font-bold text-slate-900 dark:text-white mb-2 flex items-center gap-3">
            <Folder className="text-brand-500" size={32} />
            Banco de Projetos
          </h1>
      ...
      {isFolderModalOpen && (
        <div className="fixed inset-0 z-[100] bg-slate-50 dark:bg-zinc-950 overflow-y-auto">
          <div className="max-w-xl mx-auto min-h-screen p-6 md:p-12 relative flex flex-col justify-center">
            <div className="flex items-center justify-between mb-8 md:mb-12">
              <h2 className="text-3xl md:text-5xl font-black text-slate-900 dark:text-white tracking-tight">Nova Pasta</h2>
              <button onClick={() => setIsFolderModalOpen(false)} className="w-12 h-12 bg-white dark:bg-white/5 flex items-center justify-center rounded-2xl text-slate-400 hover:text-slate-600 dark:hover:text-white transition-colors shadow-sm">
                <X className="w-6 h-6" />
              </button>
            </div>
            <form onSubmit={handleCreateFolder} className="space-y-8">
              <div className="space-y-3">
                ...
                <input 
                  ...
                  className="w-full p-5 bg-white dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-2xl focus:ring-2 focus:ring-brand-500 outline-none dark:text-white transition-all shadow-sm"
              ...
              <div className="flex gap-4 pt-4 pb-12">
                ...
                >
                  <Save className="w-6 h-6" /> Criar Pasta
                </button>
              </div>
            </form>
          </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <div className="flex gap-4 pt-4 pb-12">
                ...
                <button 
                  ...
                  className="w-2/3 bg-brand-500 hover:bg-brand-600 text-white font-black py-5 rounded-2xl transition-all shadow-xl shadow-brand-500/20 flex items-center justify-center gap-3 tracking-widest uppercase"
                >
                  <Save className="w-6 h-6" /> Salvar Anotação
                </button>
              </div>
            </form>
          </div>
